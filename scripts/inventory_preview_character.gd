...
const CHARACTER: PackedScene = preload("res://assets/marionette_hand/marionette_hand_player.glb")
...
func sync(equipped_slots: Array) -> void:
	for slot in _by_slot:
		var vis: bool = slot in equipped_slots or slot == "hand_character"
