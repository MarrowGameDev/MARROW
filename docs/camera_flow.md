...
- 2026-09-09: `scenes/player.tscn` acerca la camara inicial de 4.5 m a 3.6 m
  y baja el pivot de 0.75 m a 0.58 m para encuadrar mejor al jugador marioneta.
  El zoom manual y sus limites se mantienen sin cambios.
