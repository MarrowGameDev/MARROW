...
const DEFINITIONS := {
	...
	"heavy_bone": {
		"identity": {
			...
			"quality_damage_percent": 0.04,
			"quality_speed_percent": -0.03,
			"quality_health_percent": 0.04,
			"quality_drop_percent": -0.05,
			"quality_weight_percent": 0.1,
			"rarity": "especial",
			"rarity_rank": 4,
	...
	"rib_bone": {
		"identity": {
			...
			"quality_multiplier": 1.05,
			"quality_color": Color(0.35, 0.85, 0.95, 1.0),
			"quality_damage_percent": 0.02,
			"quality_speed_percent": 0.02,
			"quality_health_percent": 0.02,
			"quality_drop_percent": -0.05,
			"quality_weight_percent": 0.02,
			"rarity": "especial",
			"rarity_rank": 4,
			"rarity_color": Color(0.35, 0.85, 0.95, 1.0),
			"rarity_drop_weight": 0.4,
