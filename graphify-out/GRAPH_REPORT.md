...
## Knowledge Gaps
- **29 isolated node(s):** `Path`, `MARROW`, `Prefer Event Names`, `Signal Up, Call Down`, `Pass Useful Data` (+24 more)
...
- **What connects `Path`, `MARROW`, `Prefer Event Names` to the rest of the system?**
